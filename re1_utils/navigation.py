...
#Source: https://docs.hello-robot.com/0.2/stretch-tutorials/ros1/example_13/
class Nav:
    """
    ...
    def __init__(self):
        ...
        #Make a goal for the action. Specify the coordinate frame that we want,
        # in this instance the map frame. Then we set the time to be now.
